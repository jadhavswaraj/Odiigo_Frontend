...
const LocationPermissionScreen: React.FC<LocationPermissionScreenProps> = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable style={[styles.button, styles.notNowButton]} onPress={() => navigation.replace('Home')}>
...
// import AsyncStorage from '@react-native-async-storage/async-storage'; // To store/retrieve phone number
...
//           // Retrieve phone number from AsyncStorage (ensure it's stored during login)
//           let phone = await AsyncStorage.getItem('phone');
//           console.log('📞 Retrieved Phone Number:', phone);
//           if (!phone) {
//             Alert.alert(
//               'Error',
...
//           try {
//             const response = await axios.post(
//               'http://172.26.96.1:3000/api/location/store-location',
//               {
//                 phone: phone,
//                 latitude: position.coords.latitude,
//                 longitude: position.coords.longitude,
